...
function dzikirElement() {
    ...
    if (state === 3) {
        document.getElementById('message').innerHTML = '<button onclick="restart()" style="transition: background-color 0.3s; background-color: #0A4D45; color: white; padding: 15px 25px; font-size: 20px; border: none; cursor: pointer; border-radius: 8px; margin-bottom: 20px;">Zikir Lagi</button>';
